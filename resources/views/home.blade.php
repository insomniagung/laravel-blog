    ...
    @section('hero')
        <div class="w-full text-center py-32">
            <h1 class="text-2xl md:text-3xl font-bold text-center lg:text-5xl text-gray-700">
                ...
                <span class="text-yellow-500">&lt;Main.</span><span class="text-gray-900 md:text-3xl">Kode&gt;</span> belajar
                coding,
                mudah.
            </h1>
            {{-- <p class="text-gray-500 text-lg mt-1">Best Blog in the universe</p> --}}
            <p class="text-gray-500 text-lg mt-1">Website belajar bahasa pemrograman gratis.</p>
